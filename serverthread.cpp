...
*/
         if(IS_HTML)
         {
             ...
             CNLPIR *FENCI = GetActiveInstance();
             FENCI->SetAvailable(false);
    ...
    //          emit needChangeText(info_body);
             ...
             if(IS_GZIP)
             {
                ...
                emit needChangeText(tempout);
                 ...
                 tempoutword = NLPIR_ParagraphProcess(tempout);
             }
             else
             {
                 ...
                 datarequest.append(info_body);
                  emit needChangeText(info_body);
                 tempoutword = NLPIR_ParagraphProcess(info_body);
             }
    //         qDebug()<<tempout;
             emit needChangeText(tempoutword);
        //     datarequest.append(tempout);
           FENCI->SetAvailable(true);
         }
else{
         datarequest.append(info_body);
     }
